...
var app = new Vue({
  ...
  methods: {
      ...
      subscribe: function () {
          cloudmqtt = mqtt.connect("wss://vuejs:vuejs@m23.cloudmqtt.com:35317");
          cloudmqtt.subscribe("#");
          ...
          cloudmqtt.on("message", function (topic, payload) {
              ...
              app.texte = new TextDecoder("utf-8").decode(payload);
      ...
      saveColorAuto:function(){
          var currentTime = new Date();
          if (currentTime.getTime()-app.timer.getTime()>1000){
              var delims = /[(,%)]/;
              var temp = app.colorcolor(app.bgc.backgroundColor,'hsl', false).split(delims);
              app.light.hue=Math.round(temp[1]*65536/360);
              app.light.sat=Math.round(temp[2]*255/100);
      ...
      colorcolor: function (color, newColor, calculateOpacity) {
