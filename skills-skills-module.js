...
var ProgressBarComponent = /** @class */ (function () {
    ...
    ProgressBarComponent.prototype.getBgColor = function () {
        var bgColor = '';
        var minValue = this.getInterval()[1];
    ...
    ProgressBarComponent.prototype.getInterval = function () {
...
var Step = /** @class */ (function () {
    ...
    Step.prototype.getWidth = function (rank) {
...
var SkillsHomeComponent = /** @class */ (function () {
    ...
    SkillsHomeComponent.prototype.ngOnInit = function () {
        this.skillType$ = this.route.paramMap.pipe(Object(rxjs_internal_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (params) { return params.getAll('id'); }));
        this.initTheme();
    };
...
module.exports = "<mat-card *ngFor=\"let skill of skills\" [ngClass]=\"routeAnimationsElements\">\r\n  <div class=\"row\">\r\n    <div class=\"col-lg-2 skill-name\">\r\n      <h3>{{skill.name}}</h3>\r\n    </div>\r\n    <div class=\"col-lg-10\">\r\n      <spc-progress-bar [rank]=\"skill.mark\" [logo]=\"'../../../assets/skills/angular.png'\">\r\n      </spc-progress-bar>\r\n    </div>\r\n    <div class=\"col-12\" style=\"overflow: hidden\" *ngIf=\"skill.learn\" [@skillLearnState]=\"skill.learn ? 'open' : 'close'\">\r\n      <div class=\"row d-flex justify-content-center\">\r\n        <div class=\"col-lg-2\">\r\n          <h4>Description :</h4>\r\n        </div>\r\n        <div class=\"col-lg-8\">\r\n          <p>{{skill.description}}</p>\r\n        </div>\r\n      </div>\r\n      <div class=\"row d-flex justify-content-center\">\r\n        <div class=\"col-lg-2\">\r\n          <h4>Experience :</h4>\r\n        </div>\r\n        <div class=\"col-lg-8\">\r\n          <p>{{skill.experience}}</p>\r\n        </div>\r\n      </div>\r\n    </div>\r\n    <div class=\"col-12\">\r\n      <div class=\"row d-flex justify-content-end\" *ngIf=\"!skill.learn\">\r\n        <button class=\"mat-button\" (click)=\"skill.learn = true\">Learn more ...</button>\r\n      </div>\r\n      <div class=\"row d-flex justify-content-end\" *ngIf=\"skill.learn\">\r\n        <button class=\"mat-button\" (click)=\"skill.learn = false\">Less</button>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</mat-card>\r\n\r\n\r\n"
...
var SKILLS = {
    'language': [
        ...
        new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('SQL', 4, 'Domain-specific language used in programming and designed for managing data held in ' +
            ...
            'I used also a lot to manage the data of my three first websites', ['minesterstellar', 'mobilite', 'cercle'], 'sql.png'),
    ...
    'web': {
        'Front-end': [
            ...
            new _skill__WEBPACK_IMPORTED_MODULE_0__["Skill"]('AngularJS', 4, 'JavaScript-based open-source front-end web application framework', 'I learned it by myself with MOOCs to use it as frontend for my second and third websites', ['mobilite', 'cercle'], 'angularjs.png'),
